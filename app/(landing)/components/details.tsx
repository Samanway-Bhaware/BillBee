<div className=" group border-b  border-dashed text-balance text-center w-full font-semibold border-gray-300 ">
            <div className="grid grid-cols-2 px-4 relative py-6 text-3xl md:text-7xl max-w-lg mx-auto">
              <div className="flex flex-col border-r border-dashed border-gray-300">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-br from-amber-500 to-pink-400">
                  200
                </span>
        ...
        <div className="grid sm:grid-cols-2 relative">
          <Plus className="text-amber-500 group-hover:text-amber-500 w-7 h-7 absolute top-0 -translate-x-1/2 -translate-y-1/2 left-0" />
          <Plus className="text-amber-500 group-hover:text-amber-500 w-7 h-7 absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
          <div className="border-r border-b border-dashed p-7 border-gray-300 flex justify-center flex-col items-center">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300 bg-gradient-to-br from-amber-100 to-pink-100">
              <Rocket />
            </p>
        ...
        <div className="px-5 py-11 flex justify-center items-center border-b border-dashed border-gray-300">
          <div className="flex justify-center rounded-2xl max-w-3xl border-dashed items-center px-4 py-10 w-full flex-col gap-4  bg-gradient-to-br from-amber-100 to-pink-100">
            ...
            <Link
              href="/new"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring font-medium disabled:pointer-events-none disabled:opacity-50 bg-gradient-to-br from-amber-500 to-pink-400 text-white hover:bg-black/90 px-6 py-2 text-lg"
            >
              Generate Today!
            </Link>
          </div>
        ...
        <div className="flex justify-center items-center border-b border-dashed mb-20 border-gray-300 py-10 px-4 gap-4">
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a
              target="_blank"
              href="https://github.com/samanwayp10/invoice-generator"
            >
              <svg
                width="15"
                height="15"
          ...
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a target="_blank" href="https://www.linkedin.com/in/samanwayp10/">
              <Linkedin />
            </a>
          </div>
          <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl border-gray-300">
            <a target="_blank" href="https://twitter.com/Thatssamanway">
              <Twitter />
            </a>
          </div>
        </div>